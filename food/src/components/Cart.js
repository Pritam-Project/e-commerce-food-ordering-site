...
function card() {
    ...
    <div className="card">
      ...
      <div className="card-body">
        ...
        <h5 className="card-title">VEGETARIAN CUISINE</h5>
          ...
          <p className="card-text" align= "left">Nutriational Quality: Fats, Protins, Carbohydrates </p>
  ...
  <div className="col">
    <div className="card">
      ...
      <div className="card-body"> 
        ...
        <p className="card-text" align= "left"> Material: All types of Vegetable</p>
          <p className="card-text" align= "left">Nutriational Quality: Fats, Protins, Carbohydrates </p>
          <p className="card-text" align= "left"> Colour/Flavour : Most are red in colour with suger </p>
           <p className="text-muted" align= "left">More of this catagory <Link to="/display_catagory_prod" className="btn btn-info" style={{color:'white'}}>View All</Link> 
         </p>
  ...
  <div className="col">
    <div className="card">
      <img className="d-block w-100" src={process.env.PUBLIC_URL + '/images/menu1.jpg'} alt="img" />
      <div className="card-body">
   ...
   <div className="col">
     <div className="card">
       ...
       <p className="card-text" align= "left"> Material: Motton, Chiken, Fish, Egg</p>
          <p className="card-text" align= "left">Nutriational Quality: Fast, Protins, Carbohydrates </p>
          <p className="card-text" align= "left"> Colour/Flavour : Most are red in colour with suger </p>
           <p className="text-muted" align= "left">More of this catagory <Link to="/display_catagory_prod" className="btn btn-info" style={{color:'white'}}>View All</Link> 
         </p>
       </div>
