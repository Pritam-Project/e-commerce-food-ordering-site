          ...
          <div className="card-body">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <textarea value={raddress}  placeholder="Enter Restaurant Address"
                    onChange={onChangeRestAddress} rows="2" >
                </textarea>
                <br /><br />
                <textarea value={rabout}  placeholder="About Your Restaurant.."
                    onChange={onChangeRestAbout} rows="2" >
                </textarea>
                <br /><br />
           ...
           <div className='card-footer'>
            <Link to="/restaurantlogin" className="nav-link" id="signin"><i className="fas fa-sign-in-alt fa-lg"></i> <em>Already Registered? Sign in !</em></Link>
            </div>
            </div>
            <br/><br/><br/><br/><br/><br/>
            <Footer/>
