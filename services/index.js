...
const designerApi = require('./controllers/designerAPI_promise.js');
const userAPI = require('./controllers/UserAPI_promise.js');
const degprodadd = require('./controllers/designer_Add_Prod_API_promise.js');

const productRouter = require('./controllers/product-router-operation');
...
const retro_poster = require('./controllers/retro_poster_API');
app.use('/retro', retro_poster);

//USE URL /emp - route to studentController 
app.use('/comment',commentAPI);
app.use('/emp', employeeAPI);
app.use('/deg', designerApi);
app.use('/user', userAPI);
app.use('/des', degprodadd);
